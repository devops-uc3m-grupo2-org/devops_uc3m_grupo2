...
This is a class for testing the methods that are required:
    ...
    E.g. self.assertTrue(len(observations)==3263)
...
class AppTest(unittest.TestCase): 
    ...
    def test_generate_stats(self):
        ...
        self.assertTrue(stats["Download 200"]==43)
        self.assertTrue(stats["Download 206"]==2603)
        self.assertTrue(stats["Bad status"]==48)
        self.assertTrue(stats["Bad method"]==830)
        self.assertTrue(stats["Bad format resource"]==0)
        self.assertTrue(stats["Bot detected"]==3)
    ...
    def test_list_top_k_programs(self):
        ...
        self.assertTrue(top_k[0][1]==506)
        self.assertTrue(top_k[1][1]==247)
        self.assertTrue(top_k[2][1]==201)
